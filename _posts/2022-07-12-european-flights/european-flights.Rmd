...
Using the map function in the previous section returned a list of tidied flight types: the "tidy_flights_per_airport()" was applied to each item in "flight_types" individually, and the resulting tidied flight type was added to "tidy_flights_list".
